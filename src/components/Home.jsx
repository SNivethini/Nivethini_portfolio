      ...
      <div id="home" className="bg-blue-50 ">
        ...
        >
          <div className=" ">
            ...
            >
              <div className="px-[0px] py-[7px] max-w-[200px] sm:max-w-[140px] w-[100%] flex items-center justify-center text-thin md:text-lg rounded-lg border border-black bg-blue-950 text-white hover:text-black hover:bg-transparent">
                <a href={Bio.resume} target="blank">
                  <button>Resume</button>
                </a>
              </div>
              <div className=" px-[0px] py-[7px]  max-w-[200px]  sm:max-w-[140px] w-[100%] flex items-center justify-center  rounded-lg border border-black hover:bg-blue-950 hover:text-white">
                <Link to="contact">
