  ...
  return (
    <div>
        <div className="bg-blue-50">
          <div
            id="home"
            className="px-[30px] lg:pl-[300px] max-w-[1340px] w-[88%] mx-auto lg:pr-[30px] py-[100px] h-auto  flex flex-col  md:flex-row  md:justify-around "
          >
            <div className="">
              <div className=" pb-[50px]">
                ...
                <p className="text-2xl xl:text-5xl sm:text-4xl font-bold pb-[50px]">
                  <Typewriter
                    options={{
              ...
              >
                ...
                <div className=" px-[30px] py-[10px] rounded-lg border border-black hover:bg-blue-950 hover:text-white">
                  <Link to="contact">
              ...
              >
                ...
                <div className="pb-[10px] cursor-pointer hover:text-blue-700">
                  {Bio.address.city}-{Bio.address.pincode}
                </div> */}
                </div>
              </motion.div>
            </div>
